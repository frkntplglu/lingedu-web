        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="relative group">
            ...
            <img
              ...
              className="relative rounded-2xl shadow-2xl w-full h-96 object-cover transform -rotate-1 transition group-hover:rotate-0"
          ...
          <div className="space-y-6">
            <div className="bg-red-50 dark:bg-red-900/20 p-8 rounded-2xl flex flex-col justify-center items-center text-center">
            ...
            <div className="bg-teal-50 dark:bg-teal-900/20 p-8 rounded-2xl flex flex-col justify-between">
              <p className="font-medium text-teal-900 dark:text-teal-100 text-lg italic mb-5">
                "Dil öğrenmek, dünyayı farklı bir pencereden görmektir."
              </p>
              <div className="flex items-center">
                <div className="w-2.5 h-2.5 bg-teal-500 rounded-full mr-2.5"></div>
